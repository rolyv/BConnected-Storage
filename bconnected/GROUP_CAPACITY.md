...
The test invokes authenticated controller methods directly. It exercises protobuf serialization and PostgreSQL serialization/deserialization, but does not run HTTP ingress, Jetty request/body limits, TLS, Google IAM, Cloud SQL networking or iOS. Existing service/body/member limits are not changed for this test.
