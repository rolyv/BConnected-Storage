...
final class BigtableStorageStore implements StorageStore {

  private final StorageManifestsTable manifestsTable;
  private final StorageItemsTable     itemsTable;

  private static final Logger log = LoggerFactory.getLogger(BigtableStorageStore.class);

  BigtableStorageStore(BigtableDataClient client, String contactManifestsTableId, String contactsTableId) {
